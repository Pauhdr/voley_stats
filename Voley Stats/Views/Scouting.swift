...
//            HStack{
//                Text("serve".trad().capitalized).frame(maxWidth: .infinity)
//                Text("attack".trad().capitalized).frame(maxWidth: .infinity)
//            }//.frame(maxWidth: .infinity).background(.red)
//            HStack{
//                ServeScouting(viewModel: ServeScoutingModel(team: viewModel.team, scout: viewModel.scout, rotation: viewModel.rotation, showStats: viewModel.showStats))
//                AttackScouting(viewModel: AttackScoutingModel(team: viewModel.team, scout: viewModel.scout, rotation: viewModel.rotation, player: viewModel.player, showStats: viewModel.showStats))
//            }
//            HStack{
//                Text("receive".trad().capitalized).frame(maxWidth: .infinity)
//                Text("dig".trad().capitalized).frame(maxWidth: .infinity)
//            }
//            HStack{
//                ReceiveScouting(viewModel: ReceiveScoutingModel(team: viewModel.team, scout: viewModel.scout, rotation: viewModel.rotation, player: viewModel.player, showStats: viewModel.showStats))
//                DigScouting(viewModel: DigScoutingModel(team: viewModel.team, scout: viewModel.scout, rotation: viewModel.rotation, player: viewModel.player, showStats: viewModel.showStats))
//            }
        }
//        .fileMover(isPresented: $viewModel.exportScout, file: viewModel.scoutFile){result in
//            viewModel.exportScout = false
//        }
